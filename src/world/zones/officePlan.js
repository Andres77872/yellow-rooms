...
function buildCandidate(seed, dx, dz, config, candidate, context) {
  ...
  // Roles land only after every promotion: the final room set is known, and
  // the finished walls/doors are what the anchor-capacity gate measures.
  assignSpaceRoles(plan, seed, config)
