...
//
// The 'high' tier is defined FROM the legacy constants (AO_SAMPLES etc.), so
// the default desktop experience is bit-identical to the pre-settings build —
// locked by core/__tests__/graphics.test.js.
...
export const GRAPHICS_PRESETS = Object.freeze({
  low: { renderScale: 0.75, aoQuality: 'off', shadowQuality: 'low', volQuality: 'off', bloom: true, fxaa: true },
  medium: { renderScale: 1, aoQuality: 'low', shadowQuality: 'low', volQuality: 'low', bloom: true, fxaa: true },
  high: { renderScale: 1, aoQuality: 'high', shadowQuality: 'high', volQuality: 'high', bloom: true, fxaa: true },
  ultra: { renderScale: 1, aoQuality: 'ultra', shadowQuality: 'ultra', volQuality: 'ultra', bloom: true, fxaa: true },
})
